...
def determine_instcat_work_bright(instcat_list, outfile):
    """Determine how many sensors each visit will take and the number of
       ...
       the work to be done. Additionally, sort the brightest sensors to the top
    ...
    sensors_list = [run20_region.sort_bright_sensors(instcat) for instcat in instcat_list]
