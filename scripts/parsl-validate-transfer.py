...
longterm_root = os.path.commonprefix(longterm_tarballs)[:-2]	# This is the common directory structure across them.
# the dumb -2 here is to try to avoid losing the 00 in names. I need to search for a quick fix.
...
for longterm_tarball, runtime_instcat in zip(longterm_tarballs, runtime_instcats):
    ...
    print(target_path, longterm_tarball, runtime_instcat)
