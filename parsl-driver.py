...
def generate_worklist(wrap, inst_cat_root: str, work_json: str, bundle_json: str):
    base = "/global/homes/a/asv13/ALCF_1.2i/scripts/parsl-initial-worklist.py {} {} {}".format(inst_cat_root, work_json, bundle_json)
    c = wrap(base)
...
def generate_bundles(wrap, inst_cat_root: str, work_and_out_base, work_json: str, bundle_json: str, bundler_restart_path: str):
    c = wrap("/global/homes/a/asv13/ALCF_1.2i/scripts/parsl-bundle.py {} {} {} {} {}".format(inst_cat_root, work_json, bundle_json, work_and_out_base + "/run/outputs/", bundler_restart_path))
...
def run_imsim_in_singularity(wrap, nthreads: int, work_and_out_base: str, inst_cat_root: str, bundle_lists: str, nodeid: str, bundle, stdout=None, stderr=None):
    ...
    debugger_cmd = " (for i in $(seq 1 600); do echo DEBUGLOOP; date ; free -m ; ps ax -o command,pid,ppid,vsize,rss,%mem,size,%cpu ; echo END DEBUGLOOP ; sleep 1m ; done ) & "
